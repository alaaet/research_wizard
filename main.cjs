...
ipcMain.handle('searchRetrievers:search', async (event, { retriever, project_uid, project_title, queries, keywords }) => {
  ...
  return await searchClient.getResources(project_uid, project_title, queries, keywords, { retriever });
});
