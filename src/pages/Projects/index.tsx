...
import {
  ...
  PROJECT_STATUSES,
  ProjectStatus,
} from "../../lib/researchProject";
import {
  listResearchProjects,
  createResearchProject,
} from "../../connectors/researchProjectIpc";
            ...
            {projects.length === 0 ? (
              ...
              projects.map((project) => (
                <Link
                  ...
                  className="mb-3"
                >
                  <Card className="p-5 my-3 hover:bg-muted cursor-pointer shadow transition-all duration-150">
                    <div className="flex justify-between items-start">
                      ...
                      >
                        {t(
                          `projectStatus.${
                            project.status || PROJECT_STATUSES[0]
                          }`,
                          project.status || PROJECT_STATUSES[0]
                        )}
                      </Badge>
                      ...
                      project.research_questions.length > 0 && (
                        <div className="mt-2">
                          <div className="font-medium text-sm">
                            {t("projects.list.researchQuestions")}
                          </div>
